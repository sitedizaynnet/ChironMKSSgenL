...
#define STRING_CONFIG_H_AUTHOR "(Thanos Arashi)" // Who made the changes.
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 6, 6, 0.3, 20 } // ...or, set your own edit limits
  #endif
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -47.0, 0, -3.0}
